...
def checkbal(cid, office, sc):
        ...
        url = 'https://api.moru.com.np/services/nea/search'
        ...
        if response.status_code == 200:
            ...
            name=json_data['data']['customer_name']
            total_amount = json_data['data']['total_amount']
            
            return {'total_amount': total_amount,'name':name}
